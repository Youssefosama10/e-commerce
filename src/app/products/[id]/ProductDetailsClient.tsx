...
<div className="md:col-span-7 flex flex-col gap-4 sm:gap-6">
  ...
  <div className="flex flex-col sm:flex-row gap-3">
    {addcard ? (
      <button
        ...
        className="w-full sm:flex-1 inline-flex cursor-pointer items-center justify-center rounded-full bg-emerald-600 py-3 font-semibold text-white shadow-md hover:bg-emerald-700"
      >
        <MdDone />
      </button>
    ) : (
      <button
        type="button"
        onClick={handleAddToCart}
        className="w-full sm:flex-1 inline-flex cursor-pointer items-center justify-center gap-2 rounded-full bg-emerald-600 px-6 py-3 text-sm font-semibold text-white shadow-md hover:bg-emerald-700"
      >
        <FaShoppingCart />
        Add to Cart
      </button>
    ...
    <button
      ...
      className="w-full sm:flex-1 inline-flex items-center justify-center gap-2 rounded-full bg-slate-900 px-6 py-3 text-sm font-semibold text-white shadow-md hover:bg-slate-800"
    >
      <FaBolt />
      Buy Now
    </button>
  ...
  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
    <button
      type="button"
      className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-full border border-slate-200 bg-white px-5 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50"
    >
    ...
    <button
      type="button"
      className="inline-flex h-10 w-10 self-end sm:self-auto items-center justify-center rounded-full border border-slate-200 bg-white text-slate-600 hover:bg-slate-50"
    >
      <FaShareAlt />
    </button>
  </div>
  ...
  {/* Benefits strip */}
  <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 rounded-2xl border border-slate-100 bg-white px-4 py-4">
